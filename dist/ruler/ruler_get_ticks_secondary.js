export function ruler_get_ticks_secondary() {
    ...
    const handleComputeSecondaryTicks = (count) => {
        const result = [];
    ...
    if (mainTickGap >= 10)
        return handleComputeSecondaryTicks(10);
    else if (mainTickGap === 5)
        return handleComputeSecondaryTicks(5);
    else if (mainTickGap > 1 && mainTickGap < 5)
        return handleComputeSecondaryTicks(2);
    else
        return handleComputeSecondaryTicks(1);
}
